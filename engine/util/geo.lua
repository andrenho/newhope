...
function Vector:new(magnitude, direction)
...
function Vector:terminal_point(initial_point)
  ...
  return geo.Point:new(initial_point.x + self.magnitude * math.cos(dir_rad), 
                       initial_point.y - self.magnitude * math.sin(dir_rad))
end
